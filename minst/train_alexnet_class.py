...
for idx in range(8):
    # 定义训练数据集
    train_mnist = MyDataset("../data/minst_class_trainset/MINST-6742-{:0.2f}.pt".format(idx / 20 + 0.25),
                            "../data/minst_class_labels/MINST-6742-{:0.2f}-labels.pt".format(idx / 20 + 0.25))
    # 原始测试集
    ...
    net_path = "../models/class_alexnet/class_alexnet_{:0.2f}".format(idx / 20 + 0.25)
