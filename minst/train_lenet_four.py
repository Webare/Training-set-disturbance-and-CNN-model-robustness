...
for a, g, c, l in tables:
    ...
    train_mnist = MyDataset(
        "../data/minst_four_lenet_trainset/MINST-{:.0f}-{:.0f}-{:.2f}-{:.2f}-image.pt".format(a, g, c, l),
        "../data/minst_four_lenet_trainset/MINST-{:.0f}-{:.0f}-{:.2f}-{:.2f}-label.pt".format(a, g, c, l))
    ...
    net = LeNet().to(device)
    net_path = "../models/four_lenet/four_lenet_{:.0f}_{:.0f}_{:.2f}_{:.2f}.pt".format(a, g, c, l)
