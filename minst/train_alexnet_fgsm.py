...
for idx in range(9, 13):
    # 定义训练数据集
    train_mnist = MyDataset("../data/minst_fgsm_alexnet_trainset/MINST-20000-{:0.2f}-image.pt".format(idx / 2),
                            "../data/minst_fgsm_alexnet_trainset/MINST-20000-{:0.2f}——labels.pt".format(idx / 2))
    # 原始测试集
    ...
    net_path = "../models/fgsm_alexnet/fgsm_alexnet_{:0.2f}".format(idx / 2)
